...
namespace HammerAppMVC.Controllers.API
{
    public class DepartmentsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> PostDepartment(Department department)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = department.DepartmentNo }, department);
        }
        ...
        {
            return db.Departments.Count(e => e.DepartmentNo == id) > 0;
        }
    }
}